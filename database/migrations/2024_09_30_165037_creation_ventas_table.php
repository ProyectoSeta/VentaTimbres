...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ventas', function (Blueprint $table) {
            ...
            $table->integer('type')->unsigned(); ///////FORMA 14 - ESTAMPILLA
            $table->foreign('type')->references('id_tipo')->on('tipos')->onDelete('cascade');
            ...
            $table->decimal('total_bolivares', $scale = 2)->nullable();
