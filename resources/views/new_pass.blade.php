    ...
    <div class="container rounded-4 p-3 pt-1" style="background-color:#ffff;">
        <div class="d-flex justify-content-center align-items-center mb-4">
            ...
            <div class="text-center">
                <img src="{{asset('assets/user2.png')}}" class="rounded-circle mb-3" style="width:6%" alt="...">
                <h5 class="text-navy mb-0 fw-bold titulo">{{$nombre}}</h5>
                <span class="text-muted fst-italic">{{$ci}}</span>
                <div class="text-navy fw-semibold ">{{$cargo}}</div>
            ...
            <div class="modal-content" id="content_update_pass">
                <div class="modal-header p-2 pt-3 d-flex justify-content-center">
                    <div class="text-center">
                        ...
                        <h1 class="modal-title fs-5 text-navy fw-bold" id="exampleModalLabel">Nueva Contraseña</h1>
                        <div class="">
