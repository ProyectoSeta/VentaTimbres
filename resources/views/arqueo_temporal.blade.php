        ...
        <section id="" class="py-4">
            ...
            <div class="row text-center d-flex align-items-center my-3 mb-5"  >
                <div class="col-md-6">
                    ...
                    <div class="text-danger fs-5 fw-semibold">Hasta el momento (NO DEFINITIVO).</div>
                </div>
                <div class="col-md-6">
                    <div class="display-6 fw-bold text-navy"><span class="text-body-tertiary me-3">Total</span>@php echo(number_format($recaudado, 2, ',', '.')) @endphp Bs.</div>
                </div>
            </div>
            ...
            <div class="bg_arqueo" style="background-image: url({{asset('assets/fondo2.png')}});">
                <div class="row d-flex align-items-center text-center mb-5">
                    <div class="col-md-4">
                        ...
                        <h4 class="fw-semibold">@php echo(number_format($punto, 2, ',', '.')) @endphp Bs.</h4>
                    ...
                    <div class="col-md-4">
                        ...
                        <h4 class="fw-semibold">@php echo(number_format($transferencia, 2, ',', '.')) @endphp Bs.</h4>
                        @can('arqueo.cierre_punto')
                    ...
                    <div class="col-md-4">
                        <div class="">
                            ...
                            <h4 class="fw-semibold">@php echo(number_format($efectivo, 2, ',', '.')) @endphp Bs.</h4>
                        </div>
                        <div class="">
            ...
            <div class="row g-0">
                <div class="col-md-6">
                    <div class="bg-body-tertiary me-md-3 px-3 px-md-5 py-4 pb-5 text-center overflow-hidden rounded-4">
                        ...
                        <div class="d-flex flex-column">
                            <div class="fs-4 fw-semibold text-secondary">@php echo(number_format($recaudado_tfe, 2, ',', '.')) @endphp Bs.</div>  
                            <span class="text-muted">{{$cantidad_tfe}} Unidades</span>
                ...
                <div class="col-md-6">
                    <div class="bg-body-tertiary me-md-3 px-3 px-md-5 py-4 pb-5 text-center overflow-hidden rounded-4">
                        ...
                        <div class="d-flex flex-column">
                            <div class="fs-4 fw-semibold text-secondary">@php echo(number_format($recaudado_est, 2, ',', '.')) @endphp Bs.</div>  
                            <span class="text-muted">{{$cantidad_est}} Unidades</span>
                            @can('arqueo.detalle_forma')
