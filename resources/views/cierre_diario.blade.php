    ...
    <main>
        <section id="" class="py-4">
            ...
            <div class="row text-center d-flex align-items-center my-3 mb-5"  >
                <div class="col-md-6">
                    <span class="display-6 fw-bold text-navy">Recaudación | Cierre Diario</span>
            ...
            @can('pdf_cierre_diario')
                <div class="d-flex justify-content-center align-items-center flex-column">
                    <div class="fs-5 fw-semibold titulo text-navy mb-2">Descargar Reporte</div>
                    <a href="{{ route('pdf_cierre_diario', ['id' => $arqueo->id] ) }}" class="btn btn-sm btn-secondary d-inline-flex align-items-center"  role="button">
                        Reporte
                    </a>
                </div>
            @endcan
                    ...
                    <tbody>
                        @foreach ($ventas as $venta)
                            <tr>
                                ...
                                <td>{{$hora}}</td>
                                <td>
                                    <span class="badge bg-primary-subtle border border-primary-subtle text-primary-emphasis rounded-pill" style="font-size:12.7px">{{$venta->sede}}</span>
                                </td>
                                <td>
                                    <span class="text-navy fw-semibold fst-italic">{{$venta->taquillero}}</span>
                                </td>
                                <td>
