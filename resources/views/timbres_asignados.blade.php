...
@section('content')
    ...
    <div class="container rounded-4 p-3 px-0" style="background-color:#ffff;">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h2 class="text-navy fs-3 titulo fw-bold">Taquilla <sapn class="text-primary fw-bold">ID 001</sapn></h2>
        </div>

        <div class="row">
            <!-- forma 14 -->
            <div class="col-md-6 pe-5">
                <h4 class="text-navy fw-bold mb-4 text-center">Forma 14 <span class="text-muted">| TFE 14</span></h4>
            ...
            <div class="col-md-6 ps-5">
                <h4 class="text-navy fw-bold mb-4 text-center">Estampillas <span class="text-muted">| Timbre móvil</span></h4>
                <div class="table-responsive" style="font-size:12.7px">
