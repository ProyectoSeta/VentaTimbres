                ...
                <tbody>
                    @foreach ($proceso as $process)
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-outline-secondary btn-sm pb-0" data-bs-toggle="modal" data-bs-target="#modal_asignar_taquillero"><i class='bx bx-card'></i></button>                                
                            </td>
                        </tr>
                    @endforeach
                </tbody>
