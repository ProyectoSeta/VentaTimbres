...
@section('content')
    ...
    <div class="container rounded-4 p-3 px-0" style="background-color:#ffff;">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="mb-3 text-navy titulo fw-bold">Exenciones <span class="text-secondary fs-4">| Asignar Taquilleros</span></h3>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 mt-5">
            <h3 class="mb-3 text-muted titulo fw-bold">Asignadas <span class="text-secondary fs-4">| Pendientes por Imprimir</span></h3>
        </div>
                ...
                <tbody>
                    @foreach ($asignados as $asignado)
                        <tr>
                            ...
                            <td>
                                <span class="text-navy fw-bold">{{$asignado->total_ucd}} U.C.D.</span>                                    
                            </td>
                            <td>
